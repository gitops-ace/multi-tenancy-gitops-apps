...
--type Opaque \
--namespace=tools \
--dry-run=client -o yaml > delete-ibm-passwords-secret.yaml
...
kubeseal -n ${NAMESPACE} --controller-name=sealed-secrets --controller-namespace=${SEALEDSECRET_NAMESPACE} -o yaml < delete-ibm-jks-secret.yaml > ibm-jks-secret.yaml
kubeseal -n ${NAMESPACE} --controller-name=sealed-secrets --controller-namespace=${SEALEDSECRET_NAMESPACE} -o yaml < delete-ibm-passwords-secret.yaml > ibm-passwords-secret.yaml
